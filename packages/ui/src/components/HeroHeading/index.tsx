    ...
    <div>
      {eyebrow && (
        <div className="hero-eyebrow">
          ...
          {openToWork && (
            <div style={{ display: 'inline-flex', alignItems: 'center', gap: 'var(--space-8)', fontFamily: 'var(--font-mono)', fontSize: 'var(--text-11)', color: 'var(--color-teal)', background: 'var(--color-teal-dim)', border: '0.5px solid var(--color-teal-border)', borderRadius: 'var(--radius-sm)', padding: 'var(--space-4) var(--space-10)', letterSpacing: '0.04em', flexShrink: 0 }}>
